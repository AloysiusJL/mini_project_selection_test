              ...
              <Box mb={2}>
                <Grid item xs={12}>
                  <Field
                    ...
                    autoComplete="name"
                  />
                  <ErrorMessage name="fullName" component="div" style={{ fontSize: '0.8rem' }} />
                </Grid>
              </Box>
              <Box mb={2}>
                <Grid item xs={12}>
                  ...
                  />
                  <ErrorMessage name="username" component="div" style={{ fontSize: '0.8rem' }} />
                </Grid>
              </Box>
              <Box mb={2}>
                <Grid item xs={12}>
                  <Field
                    ...
                    autoComplete="email"
                  />
                  <ErrorMessage name="email" component="div" style={{ fontSize: '0.8rem' }}/>
                </Grid>
              </Box>
              <Box mb={2}>
                <Grid item xs={12}>
                  ...
                  />
                  <ErrorMessage name="password" component="div" style={{ fontSize: '0.8rem' }} />
                </Grid>
              </Box>
              <Box mb={2}>
